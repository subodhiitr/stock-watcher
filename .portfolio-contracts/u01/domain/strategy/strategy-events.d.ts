import type { ActorId, CorrelationId, EventId, StrategyVersionEventId, StrategyVersionId } from '../shared/identifiers.ts';
...
export type StrategyDomainEvent = StrategyVersionCreated | StrategyVersionSubmittedForActivation | StrategyVersionActivated | StrategyVersionSuperseded | StrategyVersionWithdrawn | AiAdvisoryAuditEvent | ProviderErrorEvent;
export type StrategyDomainEventType = StrategyDomainEvent['type'];
export declare function freezeStrategyEvent<T extends StrategyDomainEvent>(event: T): T;
