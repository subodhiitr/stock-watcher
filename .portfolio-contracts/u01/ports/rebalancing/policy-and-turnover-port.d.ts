...
import type { CostScheduleVersionId, PortfolioId, TaxRuleVersionId, TurnoverSnapshotId } from '../../domain/shared/identifiers.ts';
import type { LocalDate } from '../../domain/shared/time.ts';
export type PolicyChargeCode = 'BROKERAGE' | 'STT' | 'EXCHANGE' | 'GST' | 'SEBI' | 'STAMP_DUTY' | 'DP' | 'BROKER_FEE';
...
export type TurnoverWindowKind = 'ROLLING_30_DAY' | 'CALENDAR_MONTH' | 'CALENDAR_QUARTER' | 'CALENDAR_YEAR';
