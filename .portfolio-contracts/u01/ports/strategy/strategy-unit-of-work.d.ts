...
export interface StrategyVersionUnitOfWork {
    executeActivation(activated: StrategyVersion, previousActive: StrategyVersion | undefined, events: readonly StrategyDomainEvent[]): DomainResult<CommittedDomainResult<StrategyVersion>, AnyDomainFailure>;
}
