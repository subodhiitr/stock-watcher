...
import type { AuditIntegrityResult, AuditDecisionRecord, BackupReceipt, ComponentHealth, OperationsAlert, OperationsDashboard, IncidentRecord, JobDefinition, JobLease, JobProgress, OperationsTrigger } from '../../domain/operations/contracts.ts';
...
export interface OperationsRepositoryPort extends JobLeasePort, IncidentRepositoryPort, AuditIntegrityPort {
