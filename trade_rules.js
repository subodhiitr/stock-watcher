(function(root, factory) {
  ...
  const SETTING_DESCRIPTIONS = {
    ...
    SIMULATION_RANGEBOUND_MAX_POSITION_EXPOSURE: 'Maximum rupee exposure allowed for one Rangebound position without increasing the shared cap for other setups.',
