// Step 18: Runtime ports — interfaces/types only.
//
// Five injected capabilities that eliminate ambient global state from the
// execution layer:
//   1. ExecutionClockPort         – wall-clock time and local date
//   2. MonotonicTimePort          – monotone counter for deadline arithmetic
//   3. BoundedTimerPort           – bounded timers (no unbounded setInterval)
//   4. DeterministicSeedPort      – seedable PRNG for paper broker and tests
//   5. ExecutionIdentifierFactory – all U05 identifier factories in one place
//
// None of these interfaces may carry an implementation, SDK reference, environment
// variable, filesystem path, or network address.
